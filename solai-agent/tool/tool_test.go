...
func TestNewAgenticTool_DefaultTimeout_WhenEmpty(t *testing.T) {
	...
	at := NewAgenticTool(m, "/tools/my-tool", nil, SandboxPolicy{})
...
func TestAgenticTool_Name(t *testing.T) {
	...
	at := NewAgenticTool(m, "/tools/token-price", nil, SandboxPolicy{})
...
func TestAgenticTool_WithLLMConfig(t *testing.T) {
	...
	at := NewAgenticTool(m, "/tools/my-tool", llmCfg, SandboxPolicy{})
	if at.llmCfg == nil {
