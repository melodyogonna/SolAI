...
func TestNewAgenticTool_DefaultTimeout_WhenEmpty(t *testing.T) {
	...
	at := NewAgenticTool(m, "/tools/my-tool", nil, SandboxPolicy{}, nil, capability.NewCommunicationCapability(), nil, "")
...
func TestAgenticTool_Name(t *testing.T) {
	...
	at := NewAgenticTool(m, "/tools/token-price", nil, SandboxPolicy{}, nil, capability.NewCommunicationCapability(), nil, "")
...
func TestAgenticTool_WithLLMConfig(t *testing.T) {
	...
	at := NewAgenticTool(m, "/tools/my-tool", llmCfg, SandboxPolicy{}, nil, capability.NewCommunicationCapability(), nil, "")
	if at.llmCfg == nil {
